...
<div class="w-full">
    ...
    <form method="POST" action="{{ route('roles.store') }}" class="bg-gray-100 rounded px-8 pt-6 pb-6 mb-4">
        @csrf

        <div class="lg:w-full lg:flex">
            <div class="mb-6 lg:w-1/2 lg:pr-3">
            ...
            <div class="mb-4 lg:w-1/2">
                ...
                <div class="relative">
                    <select 
                        class="js-example-basic-multiple w-full lg:w-full @error('permissions') is-invalid @enderror" 
                        id="permissions" 
                        name="permissions[]"
